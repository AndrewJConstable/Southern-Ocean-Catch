...
CSBdata<-read.csv2('.\\CCAMLR_2019_Stat_Bull_data_Files\\AggregatedFisheryCatch.csv', header = TRUE, sep = ",", dec = ".")
cat("CSB Catch data\n")
head(CSBdata)

CEdata<-read.csv2('.\\CCAMLR_2019_Stat_Bull_data_Files\\AggregatedFisheryEffort.csv', header = TRUE, sep = ",", dec = ".")
cat("CSB Effort data\n")
head(CEdata)

CRcountry<-read.csv2('.\\CCAMLR_2019_Stat_Bull_data_Files\\ReferenceDataCountry.csv', header = TRUE, sep = ",", dec = ".")
cat("CSB Reference data - country\n")
head(CRcountry)

CRfishingActivity<-read.csv2('.\\CCAMLR_2019_Stat_Bull_data_Files\\ReferenceDataFishingActivity.csv', header = TRUE, sep = ",", dec = ".")
cat("CSB Reference data - fishing activity\n")
head(CRfishingActivity)

CRfishingGear<-read.csv2('.\\CCAMLR_2019_Stat_Bull_data_Files\\ReferenceDataFishingGear.csv', header = TRUE, sep = ",", dec = ".")
cat("CSB Reference data - fishing gear\n")
CRfishingGear

CRgeographicArea<-read.csv2('.\\CCAMLR_2019_Stat_Bull_data_Files\\ReferenceDataGeographicArea_to_MEASO.csv', header = TRUE, sep = ",", dec = ".")
cat("CSB Reference data - geographic area\n")
head(CRgeographicArea)

CRvesselSize<-read.csv2('.\\CCAMLR_2019_Stat_Bull_data_Files\\ReferenceDataVesselSize.csv', header = TRUE, sep = ",", dec = ".")
cat("CSB Reference data - vessel size\n")
head(CRvesselSize)

CSB_taxa<-read.csv2('.\\CCAMLR_2019_Stat_Bull_data_Files\\ReferenceDataTaxon_MEASO.csv', header = TRUE, sep = ",", dec = ".")
...
```{CSB-Fishing type-x-TaxaGroup-inYears, echo=FALSE}
# check for missing values
...
MCdata<-read.csv2('.\\CCAMLR-MEASO\\extract_462_MEASO_areas.csv', header = TRUE, sep = ",", dec = ".")
