...
# CCAMLR seabed areas are in km2
...
dimnames(ASD_depth_propInMEASOareas)[[2]]<- c("ASD","Depth",MEASOareas[,"Code"])

for (d in seq(1,length(Depth_intervals),1)){
DepthRange <- if(d<length(Depth_intervals)) paste(Depth_intervals[d]," : ",Depth_intervals[(d+1)]," m",sep="") else
                                            paste("deeper than ",Depth_intervals[d]," m",sep = "")
cat("\nDepth interval: ",DepthRange,"\n\n",sep="")
print(ASD_depth_propInMEASOareas[ASD_depth_propInMEASOareas[,2]==Depth_intervals[d],c(1,3:18)])
 }
