...
# Groundfish: "NOR", "TOT", "Nototheniidae"
p <- ggplot(pd[pd[,"Taxa"]=="NOR" | pd[,"Taxa"]=="TOT" | pd[,"Taxa"]=="Nototheniidae",],aes(x=Season,y=Tonnes,group=Taxa))+geom_line(linetype="blank") + geom_line(aes(col=Taxa,linetype=Taxa), size=1.5) + scale_color_manual(values=c("darkslategrey","darkslategrey","darkslategrey","darkslategrey")) + scale_linetype_manual(values=c("solid","dashed","dotted"))
